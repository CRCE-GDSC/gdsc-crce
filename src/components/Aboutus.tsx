        ...
        <div className="container mx-auto mt-8 scroll-mt-96 p-4 max-sm:mt-0 xl:py-16">
          <div className="flex items-center justify-center">
            <Image
              ...
              width={50}
              alt="left_logo"
              className="moveLeft z-50 translate-x-[125px]"
            />
            <h3 className="fadeInOut x-shadow-yellow mx-0 w-auto items-center justify-center px-0 py-3 text-center text-5xl font-bold text-black max-lg:text-4xl max-md:text-4xl max-sm:mt-0 max-sm:text-3xl">
              ABOUT US
            </h3>
            <Image
