...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      'transform-gpu bg-neutral-[950] [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]',
      className
    )}
  >
   
    <div className="">{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 pb-6 pl-6 pr-6 pt-10  transition-all duration-300 group-hover:-translate-y-10">
