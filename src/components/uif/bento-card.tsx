...
import { ArrowRightIcon } from '@radix-ui/react-icons/dist'
import { ReactNode } from 'react'

const BentoCardSingle = ({
  name,
  className,
  background,
  Icon,
  ...
  >
    <div>
      ...
      >
        <button className="hover:bg-accent hover:text-accent-foreground pointer-events-auto h-8 rounded-md px-3 text-xs">
          <a href={href}>
            {cta}
...
export default BentoCardSingle
